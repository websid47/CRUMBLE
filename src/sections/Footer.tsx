            ...
            <div key={section.title}>
              ...
              <ul className="space-y-3">
                {section.links.map((link) => {
                  const linkPath = link.toLowerCase().includes('flavor') || link.toLowerCase().includes('menu') || link.toLowerCase().includes('classic') || link.toLowerCase().includes('catering') || link.toLowerCase().includes('gift')
                    ? '/menu'
                    : link.toLowerCase().includes('contact') || link.toLowerCase().includes('faq') || link.toLowerCase().includes('shipping') || link.toLowerCase().includes('return')
                    ? '/contact'
                    : link.toLowerCase().includes('about') || link.toLowerCase().includes('career') || link.toLowerCase().includes('franchis') || link.toLowerCase().includes('press')
                    ? '/contact'
                    : '/';
                  return (
                    <li key={link}>
